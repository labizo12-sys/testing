	...
	$id=$_POST['id'];
		...
		$insert_query = mysql_query($insert);
			if($insert_query){
				...
				if($insert_query2){
				Header("location:savePDF.php?pesan=$sequence");
				}
				else{
					Header("location:inputPenjualanAdd.php?pesan=Tambah transaksi gagal $insert_query2");
				}
			}
			else{
				Header("location:inputPenjualanAdd.php?pesan=Tambah Penjualan gagal $insert");
			}
		}
		else{
	...
	if($insert_query){
		...
		$insert_query = mysql_query($insert);
			if($insert_query){
				...
				$insert_query2 = mysql_query($insert2);
				if($insert_query2){
				Header("location:inputPenjualanAdd.php?pesan=$sequence");
				}
				else{
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li ><a href="inputStock.php">Input Stock</a></li>    
        ...
        <li class="active"><a href="inputPenjualan.php">Input Penjualan</a></li>
