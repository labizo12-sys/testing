<?php 
	...
	$modal_total=$kuantiti_barang*$harga_modal;
	...
	$insert ="insert into stock values('$id','$kode_barang','$id_jual','$gramasi_barang','$kuantiti_barang','$harga_modal','$modal_total','$biaya_opr','$nama_supplier','$alamat_supplier','$tanggal_masuk','$tanggal_exp','$margin_keuntungan','$fullname','$harga_satuan');";
	$insert_query = mysql_query($insert);
			...
			$insert2 ="insert into detail_stock values('$sequence','$id_jual');";
			$insert_query2 = mysql_query($insert2);
			if(insert_query2){
			   	Header("location:listStock.php?pesan=Tambah");
			}
			else{
				Header("location:inputStock.php?pesan=Tambah transaksi gagal $insert_query2");
			}
...
<div id="content">
            ...
            <form method="POST" >
                ...
                <input type="text" id="id" name="id" class="form-control" placeholder="No Surat Jalan" required value="SJ-"><br>
                ...
                <input type="number" id="kuantiti_barang" name="kuantiti_barang" class="form-control" placeholder="kuantiti barang" step=".01" required></br>			
                ...
                <input type="number" id="harga_modal" name="harga_modal" class="form-control" placeholder="harga modal" required></br>
