...
<nav class="navbar navbar-default" id="navbar">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
        <li ><a href="inputPenjualan2.php">Input Penjualan</a></li>	
        <li class="active" ><a href="listPenjualan2.php">List Penjualan</a></li>
						...
						while($hasil=mysql_fetch_array($query_tampilkan))
							{
								...
								if($temp != $id_transaksi)
								{
									...
									<td align="center" ><a href= listPenjualanDetail2.php?id=', $id ,' target="_blank">'.$id.'</a></td>
